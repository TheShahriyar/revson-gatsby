...
const Homepage5 = () => {
    return (
        <>
            ...
            <section className="pad-t80 pad-b50 parallax" style={{backgroundImage: `url(${Bg5})`}}>
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
                            <SectionTitle title="Revson's Features" style="white" />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-4">
            ...
            <section className="pad80 parallax" style={{backgroundImage: `url(${Bg9})`, backgroundPosition: "50% 80%"}}>
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
