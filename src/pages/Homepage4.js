...
import {FaDropbox,FaGlobeAsia,FaPlaneDeparture,FaTruckMoving,FaRegHandLizard,FaUserSecret} from "react-icons/fa"
...
const Homepage4 = () => {
    return (
        <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-7">
                            <SectionTitle style="left" title="ABOUT US AND OUR PRIORITIES"/>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                            <div className="row mbl-margin-bottom">
                                <div className="col-md-6">
                                    <FeatureStyle7 icon={<FaDropbox/>} title="Packaging" subtitle="We package &amp; store"/>
                                </div>
                                <div className="col-md-6">
                                    <FeatureStyle7 icon={<FaGlobeAsia/>} title="Worldwide" subtitle="Everywhere"/>
                                </div>
                                <div className="col-md-6">
                                    <FeatureStyle7 icon={<FaPlaneDeparture/>} title="Plane" subtitle="Faster With Plane"/>
                                </div>
                                <div className="col-md-6">
                                    <FeatureStyle7 icon={<FaTruckMoving/>} title="Transporting" subtitle="We Fast Transport"/>
                                </div>
                                <div className="col-md-6">
                                    <FeatureStyle7 icon={<FaRegHandLizard/>} title="Hand to Hand" subtitle="Secure Transport"/>
                                </div>
                                <div className="col-md-6">
                                    <FeatureStyle7 icon={<FaUserSecret/>} title="Secure" subtitle="We Gurantee"/>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-5">
                            <img src={Img2} alt="" className="w-100"/>
                            <h4 style={{marginTop: "30px", marginBottom: "15px", fontSize: "18px"}}>Who We Are</h4>
                            <p>Proin eget tortor risus. Donec sollicitudin molestie malesuada. Quisque velit nisi, pretium ut lacinia in, elementum id enim. Quisque velit nisi, pretium ut lacinia in, elementum id enim. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae.</p>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="portfolio-post mb30">
                                ...
                                <div className="hover-box">
                                    <div className="inner-hover">
                                        <a className="zoom" href="#"><i className="icon-attachment"></i></a>
                                    </div>                      
                                </div>
                            </div>
                        </div>
            ...
            <section className="pad-t80 pad-b50" style={{backgroundColor: "#f3f3f3"}}>
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
