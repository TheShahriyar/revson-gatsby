...
const Homepage6 = () => {
    return (
        <>
            <HeaderStyle1/>
            <Banner style="white" bgImg={BannerImage}>
                <h1>We are Expert</h1>
            ...
            <section className="pad-t80 pad-b50" style={{backgroundColor: "#ed1c24", position: "relative"}}>
                <div className="left-half width50" style={{backgroundImage: `url(${corporateImage})`}}>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-6 col-sm-6">
                            <div className="text-section white" style={{paddingLeft: "10%"}}>
                                ...
                                <ul className="fa-ul">
                                    <li><i className="fa-li icon-paperclip"></i>Interdum et malesuada fames ac ante</li>
                                    <li><i className="fa-li icon-paperclip"></i>Malesuada fames ac ante ipsum</li>
                                    <li><i className="fa-li icon-paperclip"></i>Nam blandit quam nibh, at fermentum</li>
                                </ul>
            ...
            <section className="pad-t80 pad-b50 parallax" style={{backgroundImage: `url(${Bg6})`}}>
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
